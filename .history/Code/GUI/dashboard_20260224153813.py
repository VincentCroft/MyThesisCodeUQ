...
if _current_theme == "dark":
    ...
    :root {
        ...
        --accent-glow-soft: rgba(56,189,248,0.10);
        --metric-bg: linear-gradient(135deg, #1e293b 0%, #0f172a 100%);
        --card-bg: #1e293b;
        --shadow-color: rgba(0,0,0,0.35);
        --shadow-hover: rgba(0,0,0,0.5);
        --glass-bg: rgba(30,41,59,0.70);
        --glass-border: rgba(51,65,85,0.80);
        --glass-hover: rgba(51,65,85,0.90);
        --input-bg: #1e293b;
        --badge-normal-bg: #064e3b;  --badge-normal-text: #34d399;
        --badge-slg-bg: #7c2d12;     --badge-slg-text: #fb923c;
        --badge-ll-bg: #713f12;      --badge-ll-text: #fbbf24;
        --badge-3p-bg: #4c1d95;      --badge-3p-text: #c4b5fd;
        --badge-unk-bg: #1e293b;     --badge-unk-text: #94a3b8;
        --bar-bg: #1e293b;
        --log-bg: #0a0f1e;
        --log-text: #94a3b8;
    ...
    :root {
        ...
        --accent-glow-soft: rgba(2,132,199,0.08);
        --metric-bg: linear-gradient(135deg, #ffffff 0%, #f1f5f9 100%);
        --card-bg: #ffffff;
        --shadow-color: rgba(0,0,0,0.07);
        --shadow-hover: rgba(0,0,0,0.14);
        --glass-bg: rgba(255,255,255,0.75);
        --glass-border: rgba(203,213,225,0.80);
        --glass-hover: rgba(241,245,249,0.95);
        --input-bg: #ffffff;
        --badge-normal-bg: #d1fae5;  --badge-normal-text: #065f46;
        --badge-slg-bg: #ffedd5;     --badge-slg-text: #9a3412;
        --badge-ll-bg: #fef3c7;      --badge-ll-text: #92400e;
        --badge-3p-bg: #ede9fe;      --badge-3p-text: #5b21b6;
        --badge-unk-bg: #f1f5f9;     --badge-unk-text: #475569;
        --bar-bg: #e2e8f0;
        --log-bg: #f1f5f9;
        --log-text: #475569;
...
with st.sidebar:
  ...
  <div style="font-size:0.72rem;color:{_muted};letter-spacing:1px;text-transform:uppercase;margin-top:2px;">
    ...
    _t_tip   = "Switch to dark theme" if _current_theme == "light" else "Switch to light theme"
