...
def _plotly_iframe(fig, height: int = 350, key: str = "") -> None:
    ...
    Args:
        ...
        height: Visible height of the chart in pixels (iframe is height+8).
    ...
    # Legend config injected at layout level: toggle on click, isolate on dblclick
...
(function() {{
  ...
  // Merge legend toggle config into figure layout
  fig.layout = Object.assign(fig.layout || {{}}, patch);
  Plotly.newPlot(
    "{ uid }",
    fig.data,
    fig.layout,
    ...
    _components.html(html, height=height + 8, scrolling=False)
