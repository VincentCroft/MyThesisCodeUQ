...
def _plotly_iframe_html(fig, *, div_id: str, height: int) -> str:
    ...
    # Disable the "Produced with Plotly" / edit-related buttons, add fullscreen.
    # fullscreen uses Plotly's built-in fullscreen button.
    config = {
        "displaylogo": False,
        "responsive": True,
        "scrollZoom": True,
...
def render_plotly_stable(fig, *, key: str, height: int, use_container_width: bool = True) -> None:
