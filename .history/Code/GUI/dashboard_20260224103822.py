        ...
        if not CM_PATH.exists():
            ...
            if _PLOTLY:
                ...
                radar_fig.update_layout(
                    ...
                    margin=dict(l=10, r=220, t=50, b=10),
                    height=400,
                )
                _plotly_iframe(radar_fig, height=416, key="radar", legend_width=220)
    ...
    with tab_tsne:
        ...
        if not TSNE_PATH.exists():
            ...
            if _PLOTLY:
                ...
                _plotly_iframe(fig_tsne, height=580, key="tsne", legend_width=240)
