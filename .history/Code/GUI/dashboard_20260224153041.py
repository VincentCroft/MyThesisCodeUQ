...
LEGEND_BG = (
    "rgba(30, 41, 59, 0.8)" if _current_theme == "dark" else "rgba(255, 255, 255, 0.8)"
)
LEGEND_BORDER = (
    "rgba(255,255,255,0.1)" if _current_theme == "dark" else "rgba(0,0,0,0.1)"
)
...
LOG_BG = (
    "rgba(15, 23, 42, 0.8)" if _current_theme == "dark" else "rgba(248, 250, 252, 0.8)"
)
LOG_BORDER = (
    "rgba(255, 255, 255, 0.1)" if _current_theme == "dark" else "rgba(0, 0, 0, 0.1)"
)
            ...
            if _PLOTLY:
                if _current_theme == "dark":
                    colorscale = [
                        ...
                        [0.6, "rgba(29, 78, 216, 0.8)"],
                        [1.0, "rgba(56, 189, 248, 0.8)"],
                    ]
                else:
                    colorscale = [
                        [0.0, "rgba(248, 250, 252, 0.8)"],
                        [0.3, "rgba(186, 230, 253, 0.8)"],
                        [0.6, "rgba(56, 189, 248, 0.8)"],
                        [1.0, "rgba(2, 132, 199, 0.8)"],
                    ]
