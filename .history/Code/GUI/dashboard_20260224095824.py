...
if page == "🏠  Home":
    ...
    if hist:
        try:
            ...
            st.plotly_chart(
                fig, use_container_width=True, key="chart-dashboard-overview"
            )
        except ImportError:
    ...
    with tab_curve:
        ...
        if not hist:
            ...
            if _PLOTLY:
                ...
                with col_a:
                    st.plotly_chart(
                        fig_acc, use_container_width=True, key="chart-analysis-acc"
                    )
                with col_b:
                    st.plotly_chart(
                        fig_loss, use_container_width=True, key="chart-analysis-loss"
                    )
            else:
                st.line_chart(
            ...
            if _PLOTLY:
                ...
                st.plotly_chart(
                    fig_gap, use_container_width=True, key="chart-analysis-gap"
                )
    ...
    with tab_cm:
        ...
        if not CM_PATH.exists():
            ...
            if _PLOTLY:
                ...
                st.plotly_chart(
                    fig_cm, use_container_width=True, key="chart-analysis-cm"
                )
            else:
    ...
    with tab_report:
        ...
        if not CM_PATH.exists():
            ...
            if _PLOTLY:
                ...
                st.plotly_chart(
                    radar_fig, use_container_width=True, key="chart-analysis-radar"
                )
                ...
                st.plotly_chart(
                    fig_f1, use_container_width=True, key="chart-analysis-f1"
                )
    ...
    with tab_tsne:
        ...
        if not TSNE_PATH.exists():
            ...
            if _PLOTLY:
                ...
                st.plotly_chart(
                    fig_tsne, use_container_width=True, key="chart-analysis-tsne"
                )
                ...
                st.plotly_chart(
                    fig_dist, use_container_width=True, key="chart-analysis-dist"
                )
            else:
                st.scatter_chart(
            ...
            with st.expander(
                ...
                try:
                    ...
                    st.plotly_chart(
                        fig2,
                        use_container_width=True,
                        key=f"chart-inference-win-{fname}",
                    )
                except ImportError:
