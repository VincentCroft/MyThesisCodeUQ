    ...
    with tab_curve:
        ...
        if not hist:
            ...
            if _PLOTLY:
                ...
                with col_a:
                    st.plotly_chart(
                        fig_acc, use_container_width=True, key=f"fig_acc_{_sel_run}"
                    )
                with col_b:
                    st.plotly_chart(
                        fig_loss, use_container_width=True, key=f"fig_loss_{_sel_run}"
                    )
            else:
                st.line_chart(
            ...
            if _PLOTLY:
                ...
                st.plotly_chart(
                    fig_gap, use_container_width=True, key=f"fig_gap_{_sel_run}"
                )
        ...
        if not CM_PATH.exists():
            ...
            if _PLOTLY:
                ...
                st.plotly_chart(
                    fig_cm,
                    use_container_width=True,
                    key=f"fig_cm_{_sel_run}_{use_norm}",
                )
            else:
