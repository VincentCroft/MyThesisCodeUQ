    ...
    with tab_curve:
        ...
        if not hist:
            ...
            if _PLOTLY:
                ...
                with col_a:
                    st.plotly_chart(fig_acc, use_container_width=True, key=f"fig_acc_{_sel_run}")
                with col_b:
                    st.plotly_chart(fig_loss, use_container_width=True, key=f"fig_loss_{_sel_run}")
            else:
                st.line_chart(
            ...
            if _PLOTLY:
                ...
                st.plotly_chart(fig_gap, use_container_width=True, key=f"fig_gap_{_sel_run}")
    ...
    with tab_cm:
        ...
        if not CM_PATH.exists():
            ...
            if _PLOTLY:
                ...
                st.plotly_chart(fig_cm, use_container_width=True, key=f"fig_cm_{_sel_run}_{use_norm}")
            else:
    ...
    with tab_report:
        ...
        if not CM_PATH.exists():
            ...
            if _PLOTLY:
                ...
                st.plotly_chart(radar_fig, use_container_width=True, key=f"fig_radar_{_sel_run}")
                ...
                st.plotly_chart(fig_f1, use_container_width=True, key=f"fig_f1_{_sel_run}")
    ...
    with tab_tsne:
        ...
        if not TSNE_PATH.exists():
            ...
            if _PLOTLY:
                ...
                st.plotly_chart(fig_tsne, use_container_width=True, key=f"fig_tsne_{_sel_run}")
                ...
                st.plotly_chart(fig_dist, use_container_width=True, key=f"fig_dist_{_sel_run}")
            else:
                st.scatter_chart(
        ...
        for r in results_cache:
            ...
            with st.expander(
                ...
                try:
                    ...
                    st.plotly_chart(fig2, use_container_width=True, key=f"fig_infer_{fname}")
                except ImportError:
