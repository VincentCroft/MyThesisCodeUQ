    ...
    if hist:
        try:
            ...
            fig.update_layout(
                ...
                height=320,
                uirevision="dashboard-overview",
            )
            st.plotly_chart(fig, use_container_width=True, key="chart-dashboard-overview")
        except ImportError:
        ...
        if not hist:
            ...
            if _PLOTLY:
                ...
                fig_loss.update_layout(
                    ...
                    margin=dict(l=10, r=10, t=40, b=10),
                    height=300,
                    uirevision="analysis-loss",
                )

                col_a, col_b = st.columns(2)
                with col_a:
                    st.plotly_chart(fig_acc, use_container_width=True, key="chart-analysis-acc")
                with col_b:
                    st.plotly_chart(fig_loss, use_container_width=True, key="chart-analysis-loss")
            else:
                st.line_chart(
            ...
            if _PLOTLY:
                ...
                fig_gap.update_layout(
                    ...
                    margin=dict(l=10, r=10, t=40, b=10),
                    height=250,
                    uirevision="analysis-gap",
                )
                st.plotly_chart(fig_gap, use_container_width=True, key="chart-analysis-gap")
        ...
        if not CM_PATH.exists():
            ...
            if _PLOTLY:
                ...
                fig_cm.update_layout(
                    ...
                    height=420,
                    uirevision="analysis-cm",
                )
                st.plotly_chart(fig_cm, use_container_width=True, key="chart-analysis-cm")
            else:
        ...
        if not CM_PATH.exists():
            ...
            if _PLOTLY:
                ...
                radar_fig.update_layout(
                    ...
                    margin=dict(l=10, r=10, t=50, b=10),
                    height=380,
                    uirevision="analysis-radar",
                )
                st.plotly_chart(radar_fig, use_container_width=True, key="chart-analysis-radar")
                ...
                fig_f1.update_layout(
                    ...
                    margin=dict(l=10, r=10, t=40, b=10),
                    height=280,
                    uirevision="analysis-f1",
                )
                st.plotly_chart(fig_f1, use_container_width=True, key="chart-analysis-f1")
        ...
        if not TSNE_PATH.exists():
            ...
            if _PLOTLY:
                ...
                fig_tsne.update_layout(
                    ...
                    margin=dict(l=10, r=10, t=50, b=10),
                    height=520,
                    uirevision="analysis-tsne",
                )
                st.plotly_chart(fig_tsne, use_container_width=True, key="chart-analysis-tsne")
                ...
                fig_dist.update_layout(
                    ...
                    height=240,
                    uirevision="analysis-dist",
                )
                st.plotly_chart(fig_dist, use_container_width=True, key="chart-analysis-dist")
            else:
                st.scatter_chart(
            ...
            with st.expander(
                ...
                try:
                    ...
                    fig2.update_layout(
                        ...
                        margin=dict(l=10, r=10, t=20, b=10),
                        height=280,
                        uirevision=f"inference-win-{fname}",
                    )
                    st.plotly_chart(fig2, use_container_width=True, key=f"chart-inference-win-{fname}")
                except ImportError:
