...
def main():
    ...
    from utils.analysis import collect_predictions, save_confusion_matrix, save_tsne_embeddings
    all_preds, all_true = collect_predictions(model, val_loader, device)
    save_confusion_matrix(all_true, all_preds, CLASS_NAMES, ckpt_dir / "confusion_matrix.json")
    save_tsne_embeddings(model, val_loader, device, CLASS_NAMES, ckpt_dir / "tsne_embeddings.json")
